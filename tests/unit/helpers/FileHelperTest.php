...
class FileHelperTest extends Unit
{
	...
	{
		$fileName = VENDOR_DIR . DS . 'yii2lab/yii2-extension/tests/store/exists.file';
		$ext = FileHelper::fileExt($fileName);
		$this->tester->assertEquals($ext, 'file');
		
		$fileName = VENDOR_DIR . DS . 'yii2lab/yii2-extension/tests/store/exists';
		$ext = FileHelper::fileExt($fileName);
	...
	{
		$fileNameWithExt = VENDOR_DIR . DS . 'yii2lab/yii2-extension/tests/store/exists.file';
		$fileNameWithOutExt = VENDOR_DIR . DS . 'yii2lab/yii2-extension/tests/store/exists';
	...
	{
		$fileName = VENDOR_DIR . DS . 'yii2lab/yii2-extension/tests/store/data/main.php';
	...
	{
		$fileName = 'vendor/yii2lab/yii2-extension/tests/store/exists.file';
	...
	{
		$fileName = ROOT_DIR . DS . 'vendor/yii2lab/yii2-extension/tests/store/exists.file';
		$fileName2 = ROOT_DIR . DS . 'vendor/yii2lab/yii2-extension/tests/store/exists2.file';
	...
	{
		$fileName = ROOT_DIR . DS . 'vendor/yii2lab/yii2-extension/tests/store/exists.file';
		$fileName2 = ROOT_DIR . DS . 'vendor/yii2lab/yii2-extension/tests/store/exists_copy.file';
	...
	{
		$fileName2 = ROOT_DIR . DS . 'vendor/yii2lab/yii2-extension/tests/store/exists_saved.file';
